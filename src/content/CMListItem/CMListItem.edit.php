...
if(!empty($_REQUEST['submit'])){
	...
	$properties['orientation'] = $_REQUEST['orientation'];
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<form method="post" name="details">
			...
			<table class="edt_table" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<td class="field" colspan="2"><input type="text" id="subtitle" name="subtitle" class="edt_textboxlong" value="<?=$subtitle?>" /></td>
				</tr>
				<tr>
					<td class="label_right label_top">Text:</td>
					<td class="field" colspan="2"><textarea id="content" name="content" rows="8" class="edt_textboxlong"><?=$content?></textarea></td>
				</tr>
				<tr>
					<td class="label_right">Image:</td>
					<td class="field"><input type="text" id="image" name="image" class="edt_textbox230" value="<?=$image?>" /><a href="javascript:parent.PopupManager.showImageSelector(null,'image','PopupManager.popups.<?=$module?>.GetOwnerDocument()');"><img src="../../images/admin/common/select.png" align="top" /></a></td>	
					<td class="field">
				...
				<tr>
					<td></td>
					<td class="field" colspan="2"><input type="checkbox" id="drawline" name="drawline"<?=$drawline?' checked':''?>/> <label for="drawline" class="label_left">Draw dividing line?</label></td>
				</tr>
				<tr>
		...
		<script>if(parent && parent.PopupManager) parent.PopupManager.prepare('<?=$module?>',0,0,'List Item Editor');</script>
	</body>
</html>